...
def run_brtfrce():
    ...
    if choice == 1:
        ...
        try:
            ...
            print(Fore.GREEN + Style.BRIGHT + f"Loaded {len(lines)} passwords. Cracking...")
            ...
            for password in lines:
                ...
                if algochoice == 1:
                    ...
                    h = hashlib.sha3_384(text).hexdigest()
                elif algochoice == 5:
                    h = hashlib.sha3_512(text).hexdigest()
                elif algochoice == 6:
                    h = hashlib.blake2b(text).hexdigest()
                else:
                    h = ""
