...
def main():
    while True:
        ...
        while True:
            try:
                ...
                if choice not in range(1, 20):
                    print(Fore.RED + Style.BRIGHT + "Choose function 1-19!")
                    continue
                break
            except ValueError:
        ...
        functions = {
            ...
            6: lambda: __import__("modules.generators.generate_pswrd", fromlist=["run_run_genpassword"]).run_genpassword(),
            7: lambda: __import__("modules.attack.bruteforce", fromlist=["run_bruteforce"]).run_bruteforce(),
            ...
            10: lambda: __import__("modules.network.portscanner", fromlist=["run_portscanner"]).run_portscanner(),
            11: lambda: __import__("modules.other.pcinfo", fromlist=["run_HWIDGenerator"]).run_HWIDGenerator(),
            12: lambda: __import__("modules.network.ipcalculator", fromlist=["run_ipcalculator"]).run_ipcalculator(),
            13: lambda: __import__("modules.generators.generate_UUID", fromlist=["run_uuid_generator"]).run_uuid_generator(),
            ...
            17: lambda: __import__("modules.other.EXIFScanner", fromlist=["run_EXIF_scan"]).run_EXIF_scan(),
            18: lambda: print(Fore.CYAN + Style.BRIGHT + """
                Mlnchly - multitool with a lot of instruments for various purposes.
                """),
            19: lambda: print(Fore.CYAN + Style.BRIGHT + """
